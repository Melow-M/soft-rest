...
@Component({
  selector: 'app-edit-new-promo-dialog',
  templateUrl: './edit-new-promo-dialog.component.html',
  styleUrls: ['./edit-new-promo-dialog.component.css']
})
export class EditNewPromoDialogComponent implements OnInit {
 //Table
 ...
 initForms(){
  this.data.validityPeriod == ""
   ...
   this.promoForm = this.fb.group({
     ...
     promoPrice: [this.data.promoPrice, Validators.required],
     realPrice: [{value: this.data.realPrice, disabled: true}, Validators.required],
